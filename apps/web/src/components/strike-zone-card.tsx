  ...
  if (!summary?.available) {
    return (
      <div className="surface-panel rounded-xl p-5">
        ...
        <div className="mt-5 meta-pill inline-flex rounded-full px-3 py-1.5 text-[0.65rem] font-semibold uppercase tracking-[0.06em]">
    ...
    <div className="surface-panel rounded-xl p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="meta-pill rounded-lg px-4 py-3">
            <div className="text-[0.62rem] uppercase tracking-[0.06em] text-muted">Avg DVA</div>
            <div className="numeric mt-2 text-lg font-semibold text-ink">
              {formatSigned(summary.avg_dva)}
            </div>
          </div>
          <div className="meta-pill rounded-lg px-4 py-3">
            <div className="text-[0.62rem] uppercase tracking-[0.06em] text-muted">Outperform</div>
            <div className="numeric mt-2 text-lg font-semibold text-ink">
