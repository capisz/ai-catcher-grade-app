      ...
      <div className="loading-overlay__panel card relative w-full max-w-md overflow-hidden rounded-xl px-7 py-8 text-center shadow-[0_28px_80px_rgba(15,23,42,0.18)]">
        ...
        <div className="relative flex flex-col items-center">
          <div className="loading-emblem relative flex h-28 w-28 items-center justify-center">
            ...
            <div className="brand-loader-core flex h-20 w-20 items-center justify-center rounded-xl border border-line/70 bg-surface-elevated text-brand-primary shadow-[inset_0_1px_0_rgba(255,255,255,0.46)]">
          ...
          <h2 className="mt-5 font-serif text-2xl leading-none text-ink">
            {message}
          </h2>
