    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[110] flex items-center justify-center px-4 py-8">
          <div
            className="absolute inset-0 bg-[rgba(68,83,95,0.42)] backdrop-blur-[6px]"
            onClick={() => setOpen(false)}
          />
          <div className="card relative max-h-[90vh] w-full max-w-3xl overflow-hidden rounded-[1.7rem]">
            ...
            <div className="relative flex items-start justify-between gap-4 border-b border-line/60 px-6 py-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 font-serif text-[2rem] leading-none text-ink">
                    {catcherName}
                  </h2>
                    ...
                    <div className="grid gap-4 rounded-[1.3rem] border border-line/60 bg-surface-elevated/72 p-4 md:grid-cols-2">
                      ...
                      <label className="space-y-2">
                        ...
                        <input
                          ...
                          min="1"
                          value={minPitches}
                          onChange={(event) => setMinPitches(Number(event.target.value) || options.default_min_pitches)}
                        />
                      </label>
                    </div>
                  </section>
